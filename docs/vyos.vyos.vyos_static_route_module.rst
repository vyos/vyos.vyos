.. _vyos.vyos.vyos_static_route_module:
...
**(deprecated, removed after 2022-06-01) Manage static IP routes on Vyatta VyOS network devices**
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Network prefix of the static route. <code>mask</code> param should be ignored if <code>prefix</code> is provided with <code>mask</code> value <code>prefix/mask</code>.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        ...
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;set protocols static route 192.168.2.0/16 next-hop 10.0.0.1&#x27;]</div>
                </td>
            </tr>
    </table>
    <br/><br/>
